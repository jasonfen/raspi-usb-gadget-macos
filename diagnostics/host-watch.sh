...
echo "" >> "$L"
echo "final: $(netstat -I "$INT" -b | awk 'NR==2{print "Ipkts="$5" Opkts="$8}')" >> "$L"
echo "arp: $(arp -an | grep "$INT" | grep -v incomplete | tr '\n' ' ')" >> "$L"
echo "===== end =====" >> "$L"
